...
import com.trainreservation.dto.response.UserResponse;
...
public class AuthController {
        ...
        public ResponseEntity<ApiResponse<UserResponse>> getCurrentUser() {
                ...
                String email = authentication.getName(); // ✅ SAFE FOR JWT + OAUTH
                ...
                return ResponseEntity.ok(
                                ApiResponse.success("Current user retrieved", response));
        }
